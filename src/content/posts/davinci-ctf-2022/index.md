...
description: Write-ups for all OSINT problems in DaVinci CTF 2022.
tags: [CTF, OSINT]
category: Writeup
draft: false
---
...
From challenge description, we know right away that this is likely a Twitter account. The account is [IL0veElon](https://web.archive.org/web/20220311170444/https://twitter.com/IL0veElon). As there are not many tweets, we can go through them one by one. In fact, it turns out that only 1 post is NOT retweeting the real Elon Musk, so we can safely focus on it.
